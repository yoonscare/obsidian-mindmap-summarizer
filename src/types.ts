...
export const AVAILABLE_MODELS: Record<AIProviderType, string[]> = {
    ...
    gemini: ['gemini-2.0-flash', 'gemini-2.5-flash-preview-05-20', 'gemini-2.5-pro-preview-06-05', 'gemini-2.5-flash-preview-image-05-20', 'gemini-1.5-pro', 'gemini-1.5-flash'],
